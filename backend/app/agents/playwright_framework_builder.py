...
from app.generators.playwright.builder import build_framework_project, write_generated_artifacts
...
class PlaywrightFrameworkBuilderAgent(BaseAgent):
    """Deterministic, template-based agent (no LLM call) that assembles the complete
    Playwright/TypeScript/Cucumber.js project, mirroring FrameworkBuilderAgent's role for the
    Selenium/Java track."""

    name = "PlaywrightFrameworkBuilderAgent"
    ...
    def run(self, context: AgentContext) -> AgentResult:
        ...
        output_dir = generated_root / str(context.project_id) / str(context.generation_id) / "playwright-framework"
        ...
        try:
            ...
            zip_path = output_dir.parent / "playwright-framework.zip"
        ...
        return AgentResult(
            ...
            output_summary=f"Assembled Playwright/TypeScript project at {output_dir} and zipped to {zip_path.name}",
        )
